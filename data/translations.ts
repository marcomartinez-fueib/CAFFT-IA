...
- **Nervios:** Acepte los nervios como parte del aprendizaje.
    ...
    exposureExplanation: {
        ...
        section2TextInhibitory: "Según Michelle Craske (UCLA), la exposición no solo sirve para 'bajar la ansiedad', sino para crear un nuevo aprendizaje de seguridad que compita con el de miedo. Para maximizarlo, es necesario 'violar las expectativas' (comprobar que lo que temías no sucede) y eliminar todas las 'muletas' o señales de seguridad.",
