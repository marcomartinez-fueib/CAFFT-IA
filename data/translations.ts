...
const caTranslations: TranslationContent = {
    ...
    nav: {
        ...
        therapistDashboard: "Panell Control",
    ...
    home: {
        title: ["Tractament de la", "Por de Volar", "Assistit per Ordinador", "(CAFFT)"],
        subtitle: "Un programa de tractament psicològic per a la por de volar, basat en tècniques d'exposició gradual i recolzat per dècades d'investigació.",
...
**Tractament de la Por de Volar Assistit per Ordinador (CAFFT)**
...
- **Nervis:** Accepta els nervis com a part de l'aprenentatge.
    ...
    exposureExplanation: {
        ...
        section2SubtitleInhibitory: "Aprenentatge Inhibitori",
        section2TextInhibitory: "Segons Michelle Craske (UCLA), l'exposició no només serveix per 'baixar l'ansietat', sinó per crear un nou aprenentatge de seguretat que competeixi amb el de por. Per maximitzar-ho, cal 'violar les expectatives' (comprovar que el que temies no passa) i eliminar tots els 'recursos de seguretat' o senyals de seguretat.",
    ...
    aiChat: {
        ...
        sendButton: "Enviar",
        systemInstruction: "Ets l'assistent expert del CAFFT 5.1 (recerca UIB). REGLA CRÍTICA: NO INSISTEIXIS en continuar l'exposició o la jerarquia si l'usuari mostra dubtes, frustració o malestar. Sigues MÉS DIDÀCTIC i EXPLICATIU. REGLA D'OR: FES NOMÉS UNA PREGUNTA per resposta. No demanis informació que el sistema ja sap (com el vídeo actual, el progrés o l'estat del QPV-II). Alterna la DIRECTIVITAT amb l'ORIENTACIÓ. REGLA DE VOCABULARI: Evita 'muleta' o 'cervell'. Utilitza 'recurs de seguretat', 'estratègia', 'aprenentatge', 'habituació' o 'regulació'. Pots utilitzar [VISUAL:habituation] per mostrar el seu progrés o [VISUAL:habituation_tutorial] per explicar l'ansietat. CONTEXT: {therapeuticContext}. ESTAT QPVII: {hasCompletedQPVII}.",
...
const esTranslations: TranslationContent = {
    ...
    home: { 
        ...
        subtitle: "Un programa de tratamiento psicológico para el miedo a volar, basado en técnicas de exposición gradual y respaldado por décadas de investigación.",
...
**Tratamiento del Miedo a Volar Asistido por Ordenador (CAFFT)**
...
- **Nervios:** Acepte los nervios como parte del aprendizaje.
    ...
    aiChat: {
        ...
        sendButton: "Enviar",
        systemInstruction: "Eres el asistente experto del CAFFT 5.1 (investigación UIB). REGLA CRÍTICA: NO INSISTAS en continuar la exposición o la jerarquía si el usuario muestra dudas, frustración o malestar. Sé MÁS DIDÁCTICO y EXPLICATIVO. REGLA DE ORO: HAZ SOLO UNA PREGUNTA por respuesta. No pidas información que el sistema ya conoce (como el vídeo actual, progreso o estado QPV-II). Alterna DIRECTIVIDAD con ORIENTACIÓN. REGLA DE VOCABULARIO: Evita 'muleta' o 'cerebro'. Usa 'recurso de seguridad', 'estrategia', 'aprendizaje', 'habituación' o 'regulación'. Puedes usar [VISUAL:habituation] para su progreso o [VISUAL:habituation_tutorial] para explicar la ansiedad. CONTEXTO: {therapeuticContext}. ESTADO QPVII: {hasCompletedQPVII}.",
    ...
    exposureExplanation: {
        ...
        section2SubtitleInhibitory: "Aprendizaje Inhibitorio",
        section2TextInhibitory: "Según Michelle Craske (UCLA), la exposición no solo sirve para 'bajar la ansiedad', sino para crear un nuevo aprendizaje de seguridad que compita con el de miedo. Para maximizarlo, es necesario 'violar las expectativas' (comprobar que lo que temías no sucede) y eliminar todos los 'recursos de seguridad' o señales de seguridad.",
...
const enTranslations: TranslationContent = {
    ...
    home: {
        ...
        subtitle: "A psychological treatment program for fear of flying, based on gradual exposure techniques and supported by decades of research.",
    ...
    aiChat: {
        ...
        sendButton: "Send",
        systemInstruction: "You are the CAFFT 5.1 expert assistant (UIB research). CRITICAL RULE: DO NOT INSIST on exposure if the user shows doubt or frustration. Be MORE DIDACTIC and EXPLANATORY. GOLDEN RULE: ASK ONLY ONE QUESTION per turn. Do not ask for information the system already knows (current video, progress, or QPV-II status). Alternate DIRECTIVITY with ORIENTATION. VOCABULARY RULE: Avoid 'crutch' or 'brain'. Use 'safety resource', 'strategy', 'learning', 'habituation', or 'regulation'. You can use [VISUAL:habituation] for progress or [VISUAL:habituation_tutorial] to explain anxiety. CONTEXT: {therapeuticContext}. QPVII STATUS: {hasCompletedQPVII}.",
    ...
    exposureExplanation: {
        ...
        section2SubtitleInhibitory: "Inhibitory Learning",
        section2TextInhibitory: "According to Michelle Craske (UCLA), exposure doesn't just serve to 'lower anxiety', but to create a new safety learning that competes with the fear learning. To maximize this, it is necessary to 'violate expectations' (check that what you feared does not happen) and eliminate all 'safety behaviors' or safety signals.",
