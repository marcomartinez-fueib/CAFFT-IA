...
// Path relative to the video root, resolved by resolveVideoUrl() against the
// app's base path. Expects files named exposure_explanation_<lang>.mp4 in
// public/videos_cafft/ (served as <base>/videos_cafft/).
export const EXPOSURE_EXPLANATION_VIDEO_URL_BASE = "videos_cafft/exposure_explanation";
