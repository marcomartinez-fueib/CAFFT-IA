...
// GitHub Release video URLs
const VIDEOS_BASE_URL = 'https://github.com/marcomartinez-fueib/CAFFT-IA/releases/download/v1.0.0-videos/';

export const EXPOSURE_EXPLANATION_VIDEO_URL_BASE = `${VIDEOS_BASE_URL}exposure_explanation`;
